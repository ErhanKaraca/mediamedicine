...
export const EDGE_ROUTE_MAP: EdgeRouteMapping[] = [
  ...
  { method: "POST", path: "/v1/kyc/upload-init", functionName: "kyc-upload-init", requiresAuth: true, tag: "write" },
  { method: "POST", path: "/v1/kyc/cases", functionName: "kyc-create-case", requiresAuth: true, tag: "write" },
  { method: "PATCH", path: "/v1/kyc/cases/:caseId", functionName: "kyc-update-case", requiresAuth: true, tag: "write" },
  { method: "POST", path: "/v1/kyc/cases/:caseId/documents", functionName: "kyc-attach-document", requiresAuth: true, tag: "write" },
  { method: "DELETE", path: "/v1/kyc/cases/:caseId/documents/:documentId", functionName: "kyc-delete-document", requiresAuth: true, tag: "write" },
  { method: "POST", path: "/v1/kyc/cases/:caseId/submit", functionName: "kyc-submit-case", requiresAuth: true, tag: "write" },
  { method: "POST", path: "/v1/kyc/cases/:caseId/withdraw", functionName: "kyc-withdraw-case", requiresAuth: true, tag: "write" },
  { method: "POST", path: "/v1/staff/kyc/cases/:caseId/review", functionName: "kyc-review-case", requiresAuth: true, tag: "write" },
  { method: "POST", path: "/v1/account/export", functionName: "account-export", requiresAuth: true, tag: "write" },
